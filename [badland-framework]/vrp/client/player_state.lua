...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(660187807402426368)--Colocar o ID do Dispatch aq
		SetDiscordRichPresenceAsset('amgcity')--a logo tem que ser colocada no Dispatch criada no site do discord 
        SetDiscordRichPresenceAssetText('AMG City')
        SetDiscordRichPresenceAction(0, "Conectar", "fivem://connect/201.76.43.233:2120")
        SetDiscordRichPresenceAction(1, "Discord", "https://discord.gg/FKMM2t336D")
	end
end)
