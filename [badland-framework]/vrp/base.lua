...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local enterLog = "https://discord.com/api/webhooks/842468356442816532/bjexoVqbZtPLrDze8NNDnuajK3272xQCgm7A5t1YbmHvdsRMVs7s3dOqDJS9ovdSD2tE"
local leaveLog = "https://discord.com/api/webhooks/842468410734149712/A1Fv2mpT_VfBXTVU5wxcqFL5UvHBoZQb-ycK4cF1mI_A_6jji98Z2LynmG_edmEjvXp3"
-----------------------------------------------------------------------------------------------------------------------------------------
-- BASE.LUA
-----------------------------------------------------------------------------------------------------------------------------------------
				...
				if vRP.isWhitelisted(user_id) then
					--if user_id < 20 then
						if vRP.rusers[user_id] == nil then
							...
							print("Jogador se conectando ID:"..user_id.."")
					...
					--else
					--	deferrals.done("\n\nAMG City® Season 2.\n\nCidade está em manunteção, em breve voltará!.\n discord.gg/FKMM2t336D")
					--	TriggerEvent("queue:playerConnectingRemoveQueues",ids)
					--end
				else
					deferrals.done("\n\nAMG City® Season 2\n\nUm nova experiência chegou! Envie seu ID em nosso discord.\n\n discord.gg/amgcity - [ ID: "..user_id.." ]")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Você foi banido!")
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
