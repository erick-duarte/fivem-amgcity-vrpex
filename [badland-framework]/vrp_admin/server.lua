...
local logAdmin = "https://discord.com/api/webhooks/842541416232124466/UcQJC96TBQVs56ckphdhiMKDZv2zmv-JCx3HjbPCvsH7DwrNHojII2x6s8JVa3olcNgP"
local pontostaff = "https://discord.com/api/webhooks/847831591954415667/2YK5YY_VvVtxGxyysMs_AsphH4KdByjp7VMe-KP8WS_KbkpIbZFFuG1JA1yn-HYjQf48"
...
local itemlist = {
	...
	["componentes"] = { index = "componentes", nome = "Componentes" },
	...
	["componenteeletronico"] = { index = "componenteeletronico", nome = "Componentes Elet." },
	...
	["maconhasemente"] = { index = "maconhasemente", nome = "Sem. de Maconha"},
	["papoulasemente"] = { index = "papoulasemente", nome = "Sem. de Papoula"},
	["cocainasemente"] = { index = "cocainasemente", nome = "Sem. de Cocaina"},
	...
	["metasuja"] = { index = "metasuja", nome = "Metanf. Suja" },
	...
	["wammo|WEAPON_SPECIALCARBINE"] = { index = "m-parafal", nome = "PARAFAL" },
	-- SMGs
...
RegisterCommand('group',function(source,args,rawCommand)
	...
	elseif vRP.hasPermission(user_id,"manager.permission") then
		if args[1] and args[2] then
			if args[2] ~= "founder" and args[2] ~= "manager" and args[2] ~= "admin" and args[2] ~= "mod" and args[2] ~= "support" and args[2] ~= "off-founder" and args[2] ~= "off-manager" and args[2] ~= "off-admin" and args[2] ~= "off-mod" and args[2] ~= "off-support" and args[2] ~= "pass-bronze" and args[2] ~= "pass-prata" and args[2] ~= "pass-ouro" and args[2] ~= "pass-platina" and args[2] ~= "pass-amg" then
				vRP.addUserGroup(parseInt(args[1]),args[2])
				TriggerClientEvent("Notify",source,"sucesso","Voce setou o passaporte <b>"..parseInt(args[1]).."</b> no grupo <b>"..args[2].."</b>.")
				PerformHttpRequest(logAdmin, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = "REGISTRO DE COMANDO /GROUP:⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀",thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Quem usou o comando:**",value = "` "..identity.name.." "..identity.firstname.." ` "},{ name = "**Nº do Passaporte:**", value = "` "..user_id.." ` "},{ name = "**Setou o Passaporte:**", value = "` "..args[1].." ` "},{ name = "**No grupo:**", value = "` "..args[2].." `"},}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 15914080}}}), { ['Content-Type'] = 'application/json' })
			else
				TriggerClientEvent("Notify",source,"negado","Você não ter permissão para setar esse grupo.")
			end
		end
	end
end)
	...
	elseif vRP.hasPermission(user_id,"manager.permission") then
		if args[1] and args[2] then
			if args[2] ~= "founder" and args[2] ~= "manager" and args[2] ~= "admin" and args[2] ~= "mod" and args[2] ~= "support" and args[2] ~= "off-founder" and args[2] ~= "off-manager" and args[2] ~= "off-admin" and args[2] ~= "off-mod" and args[2] ~= "off-support" and args[2] ~= "pass-bronze" and args[2] ~= "pass-prata" and args[2] ~= "pass-ouro" and args[2] ~= "pass-platina" and args[2] ~= "pass-amg" then
				...
				TriggerClientEvent("Notify",source,"negado","Você não ter permissão para remover esse grupo.")
			end
		end
	end
end)
...
RegisterCommand('staffoff',function(source,args,rawCommand)
	...
	elseif vRP.hasPermission(user_id,"admin.permission") then
		...
		vRP.addUserGroup(user_id,"off-admin")
		TriggerClientEvent("Notify",source,"sucesso","Você saiu de serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Saiu de serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"mod.permission") then
		vRP.removeUserGroup(user_id,"mod")
		vRP.addUserGroup(user_id,"off-mod")
		TriggerClientEvent("Notify",source,"sucesso","Você saiu de serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Saiu de serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })
		
	elseif vRP.hasPermission(user_id,"support.permission") then
		vRP.removeUserGroup(user_id,"support")
		vRP.addUserGroup(user_id,"off-support")
		TriggerClientEvent("Notify",source,"sucesso","Você saiu de serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Saiu de serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"off-staff.permission") then
...
RegisterCommand('staffon',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	local identity = vRP.getUserIdentity(user_id)
	if vRP.hasPermission(user_id,"off-founder.permission") then
		vRP.removeUserGroup(user_id,"off-founder")
		vRP.addUserGroup(user_id,"founder")
		TriggerClientEvent("Notify",source,"sucesso","Você entrou em serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Entrou em serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"off-manager.permission") then
		vRP.removeUserGroup(user_id,"off-manager")
		vRP.addUserGroup(user_id,"manager")
		TriggerClientEvent("Notify",source,"sucesso","Você entrou em serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Entrou em serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"off-admin.permission") then
		vRP.removeUserGroup(user_id,"off-admin")
		vRP.addUserGroup(user_id,"admin")
		TriggerClientEvent("Notify",source,"sucesso","Você entrou em serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Entrou em serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"off-mod.permission") then
		vRP.removeUserGroup(user_id,"off-mod")
		vRP.addUserGroup(user_id,"mod")
		TriggerClientEvent("Notify",source,"sucesso","Você entrou em serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Entrou em serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })
		
	elseif vRP.hasPermission(user_id,"off-support.permission") then
		vRP.removeUserGroup(user_id,"off-support")
		vRP.addUserGroup(user_id,"support")
		TriggerClientEvent("Notify",source,"sucesso","Você entrou em serviço.",5000)
		PerformHttpRequest(pontostaff, function(err, text, headers) end, 'POST', json.encode({embeds = {{ title = identity.name.." "..identity.firstname, description = "Entrou em serviço.\n⠀", thumbnail = {url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png"}, fields = {{ name = "**Nº Passaporte:**", value = "` Número "..user_id.." `\n⠀" }}, footer = { text = os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S"), icon_url = "https://cdn.discordapp.com/attachments/740912067095035955/757142616054824970/badland2.png" },color = 4360181 }}}), { ['Content-Type'] = 'application/json' })

	elseif vRP.hasPermission(user_id,"staff.permission") then
