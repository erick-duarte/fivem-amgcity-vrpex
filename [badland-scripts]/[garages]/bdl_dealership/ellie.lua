...
vRP._prepare("dealership/get_estoque","SELECT vehicle,nome,categoria,mala,valor,quantidade FROM vrp_estoque")
...
Citizen.CreateThread(function()
	vehicles = vRP.query("dealership/get_estoque")
	for k2,v2 in ipairs(vehicles) do
		if v2.categoria == "carros" then
			table.insert(carros,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
		if v2.categoria == "motos" then
			table.insert(motos,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
		if v2.categoria == "import" then
			table.insert(import,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
		if v2.categoria == "offroad" then
			table.insert(offroad,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
		if v2.categoria == "vans" then
			table.insert(vans,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
		if v2.categoria == "vips" then
			table.insert(vips,{ k = v2.vehicle, nome = v2.nome, price = v2.valor, chest = v2.mala, stock = parseInt(v2.quantidade) })
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
