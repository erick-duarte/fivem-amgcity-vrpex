...
client_scripts {
    ...
    "amg_plantar/client.lua",
    "amg_lavagem/client.lua",

    "amg_encomendas/client.lua",
    "amg_encomendas/config.lua",

    "amg_vendausados/config.lua",
    "amg_vendausados/client.lua",
...
server_scripts{
    ...
    "amg_plantar/server.lua",

    "amg_lavagem/server.lua",

    "amg_encomendas/server.lua",
    "amg_encomendas/config.lua",

    "amg_vendausados/config.lua",
    "amg_vendausados/server.lua",
