...
--            args = { fal, message }
--        })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "TWITTER", "ID: "..user_id.." enviou no Twitter: "..message , AvatarURL, false, false)
--end)
...
--            end
--        end
--        TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "ILEGAL", "ID: "..user_id.." enviou no Ilegal: "..message , AvatarURL, false, false)
--    end
--end)
...
--        args = { fal, message }
--    })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "MERCADO LIVRE", "ID: "..user_id.." enviou no ML: "..message , AvatarURL, false, false)
--end, false)
--
...
--        args = { fal, message }
--    })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "ACAO", "ID: "..user_id.." enviou no AçãoPM: "..message , AvatarURL, false, false)
--end, false)
...
--        args = { fal, message }
--    })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "ACAO", "ID: "..user_id.." enviou no Bandidos: "..message , AvatarURL, false, false)
--end, false)
...
--                    TriggerClientEvent('chatMessage',v,"PD: "..fal,{36, 177, 163},message)
--                end
--            end
--        end
--    end
...
--        args = { fal, message }
--    })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "Emergência", "ID: "..user_id.." enviou no SAMU 192: "..message , AvatarURL, false, false)
--end, false)
...
--        args = { fal, message }
--    })
--    TriggerEvent('DiscordBot:ToDiscord', WebHookSvChat, "PREFEITURA", "ID: "..user_id.." enviou no Admin: "..message , AvatarURL, false, false)
--    end
--end, false)
...
--[[ RegisterCommand('mec', function(source, args, rawCommand)
    ...
    fal = identity.name.. " " .. identity.firstname
    TriggerClientEvent('chat:addMessage', -1, {
        template = '<div style="padding: 0.5vw; margin: 0.5vw; background-image: linear-gradient(to right, rgba(255, 140, 0,0.9) 3%, rgba(0, 0, 0,0) 95%); border-radius: 15px 50px 30px 5px;"><img style="width: 18px" src="https://image.flaticon.com/icons/svg/1077/1077147.svg%22%3E @{0}: {1}</div>',
        args = { fal, message }
    })
end, false) ]]
