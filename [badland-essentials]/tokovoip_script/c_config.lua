...
--	playerListRefreshRate = 5000, -- Rate at which the playerList is updated
	...
	radioClickMaxChannel = 1200, -- Set the max amount of radio channels that will have local radio clicks enabled
	...
	plugin_data = {
		...
		TSChannel = "CONECTADO",
		TSPassword = "ac58d7ac58d7", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "amgroleplay.meuts3.com", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "AMG City", -- If set, this name will be used as the user's teamspeak display name
