$(function() {
	...
	window.addEventListener("message", function(event) {
	  ...
	  if (item.gender == "male") {
		$('.enfermeiro').attr('src','media/img/enfermeiroM.png');
		$('.paramedico').attr('src','media/img/paramedicoM.png');
		$('.medico').attr('src','media/img/medicoM.png');
		$('.clinico').attr('src','media/img/clinicoM.png');
		$('.diretor').attr('src','media/img/diretorM.png');
		$('.resgate').attr('src','media/img/resgateM.png');
	} else if (item.gender == "female") {
		$('.enfermeiro').attr('src','media/img/enfermeiroF.png');
		$('.paramedico').attr('src','media/img/paramedicoF.png');
		$('.medico').attr('src','media/img/medicoF.png');
		$('.clinico').attr('src','media/img/clinicoF.png');
		$('.diretor').attr('src','media/img/diretorF.png');
		$('.resgate').attr('src','media/img/resgateF.png');
	}
	});
