...
local onServiceHP = "https://discord.com/api/webhooks/846124679021461506/kCOHU1vbVmVtV9LI0JovwFcwPtRW8ENPrss1fF0luLJdWcD2h8-PiWTxDo5GOhe4YqcV"
local offServiceHP = "https://discord.com/api/webhooks/846124731828273222/W-60rwx5FKJetndFnYg-58pTHGihCC-ce18iH0FD_44NGXwK1oZTgyVx-TxQJteJFZYT"
local actionsLog = "https://discord.com/api/webhooks/846124782327955476/WmLkDQkxdk6RqTSK4VQu5PGPSEVTfbOca9ANaOCZSF1ebOkjxKyRMS9TA8vUXYe3KzdP"
...
AddEventHandler("bdl:onservice",function()
    ...
    if vRP.hasPermission(user_id,"off-ems.permission") then
		...
		TriggerEvent('eblips:add',{ name = "HOSPITAL", src = source, color = 47 })
...
AddEventHandler("bdl:offservice",function()
    ...
    if vRP.hasPermission(user_id,"ems.permission") then
        vRP.addUserGroup(user_id,"off-hospital")
