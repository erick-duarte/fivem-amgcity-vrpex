...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "fabricar-parafal" then
		ToggleActionMenu()
		TriggerServerEvent("bdl_gunfactory:weaponfactory","parafal")

	elseif data == "fabricar-ak103" then
		ToggleActionMenu()
...
--[[	elseif data == "fabricar-m1911" then
	...
	elseif data == "fabricar-fiveseven" then
		ToggleActionMenu()
		TriggerServerEvent("bdl_gunfactory:weaponfactory","fiveseven")
