...
local blips = {}
local marketLog = "https://discord.com/api/webhooks/845398934415081552/g_WASZqhob3syFC6hgmQYKOOh-mLGEKAoIuu2UiRc3TX1Ht25Wc_LwIPNMAGWxMrGJrQ"
local registradoraLog = "https://discord.com/api/webhooks/845398742936977448/MOstqMZXTHNT6hwfqzGxtWBGYutX5HkDWnXN2BPDsyUcMxc7JrmEMUYuQpDIWBY7qDpd"
...
-- [ TABELA ] --
local valores = {
	{ item = "sanduiche", quantidade = 1, compra = 500 },
	{ item = "rosquinha", quantidade = 1, compra = 500 },
	{ item = "hotdog", quantidade = 1, compra = 500 },
	{ item = "xburguer", quantidade = 1, compra = 500 },
    { item = "chips", quantidade = 1, compra = 500 },
    { item = "batataf", quantidade = 1, compra = 500 },
    { item = "pizza", quantidade = 1, compra = 500 },
	{ item = "taco", quantidade = 1, compra = 500 },
	{ item = "agua", quantidade = 1, compra = 400 },
	{ item = "cola", quantidade = 1, compra = 400 },
	{ item = "sprunk", quantidade = 1, compra = 400 },
	{ item = "energetico", quantidade = 1, compra = 2000 },
    { item = "leite", quantidade = 1, compra = 400 },
    { item = "barracho", quantidade = 1, compra = 200 },
    { item = "patriot", quantidade = 1, compra = 200 },
    { item = "pibwassen", quantidade = 1, compra = 200 },
	
	{ item = "mochila", quantidade = 1, compra = 3000 },
	{ item = "repairkit", quantidade = 1, compra = 5000 },
	{ item = "britadeira", quantidade = 1, compra = 1000 },
	{ item = "garrafavazia", quantidade = 1, compra = 150 },
	{ item = "s-blueberry", quantidade = 1, compra = 125 },
	{ item = "adubo", quantidade = 1, compra = 250 },

	{ item = "celular", quantidade = 1, compra = 4000 },
	{ item = "roupas", quantidade = 1, compra = 1000 },
	{ item = "radio", quantidade = 1, compra = 1500 },

	{ item = "isca", quantidade = 1, compra = 50 },

	{ item = "militec", quantidade = 1, compra = 3000 },
	{ item = "pneus", quantidade = 1, compra = 2500 },
}
