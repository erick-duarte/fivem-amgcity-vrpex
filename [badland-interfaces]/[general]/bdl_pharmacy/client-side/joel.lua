...
vRPex = Tunnel.getInterface("bdl_pharmacy")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "comprar-dorflex" then
		TriggerServerEvent("ph-comprar","dorflex")

	elseif data == "comprar-voltaren" then
		TriggerServerEvent("ph-comprar","voltaren")
		
	elseif data == "comprar-tandrilax" then
		TriggerServerEvent("ph-comprar","tandrilax")
		
	elseif data == "comprar-buscopan" then
		TriggerServerEvent("ph-comprar","buscopan")
		
	elseif data == "comprar-paracetamol" then
		TriggerServerEvent("ph-comprar","paracetamol")
