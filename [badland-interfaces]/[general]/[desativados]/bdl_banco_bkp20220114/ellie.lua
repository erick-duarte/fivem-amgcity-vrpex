...
-- [ WEBHOOKS ] --
local depositLog = "https://discord.com/api/webhooks/845397191743897640/Mg1Ih7ymZsEXIWLGfhoMhLIK5SamuSDKvZrzTSYuwEVLMDEs_Wxphdx1QtMpxhNNOsrh"
local withdrawLog = "https://discord.com/api/webhooks/845397350779191297/aZyCGuwak7er7FxBSBY-RKgw5lPquByRpp3alV-qqSj7frhMW2WsAlWp50Q_CTRCnzcv"
local citationLog = "SEULINK"
local transferLog = "https://discord.com/api/webhooks/842551599427747840/mePS0xv0SLeAfnsnSWiknW8V8SdRkKyBJZ3BVMlFnR0OufvCZ0kV8Q9uFNQxDpI3oiQz"
local caixinhaLog = "https://discord.com/api/webhooks/845397676044713984/4j4S0AGaoI8-C_Ern5qunJHfFsUgiaomd2bO-UWmOXbDE00ltZ2dkS8cJDXSkYlC1tmJ"
		...
		if not vRP.hasPermission(user_id,"lspd.permission") or vRP.hasPermission(user_id,"ems.permission") or vRP.hasPermission(user_id,"bennys.permission") then
			...
			elseif (os.time()-timers) <= 1800 then
				...
				--if yes then
					...
					recompensa = parseInt(math.random(7000,8000)/caixas[id].seconds)
