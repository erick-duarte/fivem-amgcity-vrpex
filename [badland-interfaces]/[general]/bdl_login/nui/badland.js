...
$('#secondLoc').click(function() {
	...
	$('.ilustration').attr('src','https://cdn.discordapp.com/attachments/836271378150719511/852896030479351808/unknown.png');
	// Hides & Shows //
	$('#beach').show();
	$('#hospital').hide();
	$('#paleto').hide();
...
$('#thirdLoc').click(function() {
	...
	$('.ilustration').attr('src','https://cdn.discordapp.com/attachments/836271378150719511/852895842397585418/unknown.png');
	// Hides //
	$('#paleto').show();
	$('#hospital').hide();
	$('#beach').hide();
...
$('#fourthLoc').click(function() {
	...
	$('.ilustration').attr('src','https://cdn.discordapp.com/attachments/836271378150719511/852895959692476426/unknown.png');
	// Hides //
	$('#sandys').show();
	$('#hospital').hide();
	$('#beach').hide();
...
$('#sixthLoc').click(function() {
	...
	$('.ilustration').attr('src','https://cdn.discordapp.com/attachments/836271378150719511/850120855602069524/unknown.png');
	// Hides //
	$('#lsgarage').show();
	$('#hospital').hide();
	$('#beach').hide();
