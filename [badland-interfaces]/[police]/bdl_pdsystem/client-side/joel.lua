...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "pistol" then
		if vRPex.checkPermission("lspd.permission") then
			RemoveWeaponFromPed(ped,GetHashKey("WEAPON_COMBATPISTOL"))
			GiveWeaponToPed(ped,GetHashKey("WEAPON_PISTOL"),75,0,0)
			TriggerEvent("Notify","sucesso","Você pegou uma FN M1911 do arsenal.",9000)
			TriggerServerEvent("bdl:takeWeapons","FN M1911")
		else
			TriggerEvent("Notify","negado","Você precisa entrar em serviço para isso.",9000)
		end
...
RegisterNetEvent("bdl_pdsystem:removerarmamento")
AddEventHandler("bdl_pdsystem:removerarmamento",function()
	Citizen.Wait(15000)
